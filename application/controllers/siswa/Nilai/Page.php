...
class Page extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url']         = base_url('Admin/Siswa/Page');

        $config['total_rows']       = $this->Nilai_model->Get_Total_Nilai_Siswa();
        $config['per_page']         = $limit;

        $param['data']            = $this->Nilai_model->Get_Nilai_Siswa_ID($id_siswa, $config['per_page'], $start);
        ...
        $this->load->view('siswa/nilai/index', $param);
    }
}
